...
#print("TESTCLASSIFIER BASIC DATASET IRIS")
#testClassifier(BayesClassifier(), dataset='iris', split=0.7)


#print("TESTCLASSIFIER BASIC DATASET VOWEL")
...
#print("TESTCLASSIFIER BOOST DATASET IRIS")
testClassifier(BoostClassifier(BayesClassifier(), T=10), dataset='iris',split=0.7)


#print("TESTCLASSIFIER BOOST DATASET VOWEL")
...
#print("DECISION TREE BASIC IRIS")
#testClassifier(DecisionTreeClassifier(), dataset='iris', split=0.7)


#print("DECISION TREE BOOST IRIS")
